...
* the test cases I used during the task implementation.  First I did all of my solution in Eclipse IDE 
* after I was happy with the solution in Eclipse I passed it to the Codility platform to Submit and to verify.

## Other notes

* I realized that if my solution passed 100% first when I submitted that again it doesn't need to pass 100%. It is because the Codility platform has some random array for the 'maximal' test so you might be lucky with the not the fastest solution :).
...
* if you use the browser to build your solution - every edit and run is recorded and presented to the client
* before submitting your solution, there is no feedback regarding its efficiency; but it does affect your score and report
